private void register_min_bound_line() {
    Test.add_func("/LiveChart/MinBoundLine#all_series", () => {
        //Given
    ...
    Test.add_func("/LiveChart/MinBoundLine#one_serie", () => {
        //Given
        Cairo.ImageSurface surface = new Cairo.ImageSurface(Cairo.Format.ARGB32, SURFACE_WIDTH, SURFACE_HEIGHT);
        Cairo.Context context = new Cairo.Context(surface);
        cairo_background(context);
...
private void register_experimental_min_bound_line() {
    Test.add_func("/LiveChart/MinBoundLineSerie#all_series", () => {
        ...
        chart.series.register(new LiveChart.MinBoundLineSerie("MIN")).line.color = Gdk.RGBA() {red = 0.0, green = 0.0, blue = 1.0, alpha = 1.0 };;
    ...
    Test.add_func("/LiveChart/MinBoundLineSerie#one_serie", () => {
        //Given
        Cairo.ImageSurface surface = new Cairo.ImageSurface(Cairo.Format.ARGB32, SURFACE_WIDTH, SURFACE_HEIGHT);
        Cairo.Context context = new Cairo.Context(surface);
        cairo_background(context);
        ...
        try {
            chart.series.register(new LiveChart.LineSerie("S1")).line.color = Gdk.RGBA() {red = 1.0, green = 0.0, blue = 0.0, alpha = 1.0 };
            chart.series.register(new LiveChart.LineSerie("S2")).line.color = Gdk.RGBA() {red = 0.0, green = 1.0, blue = 0.0, alpha = 1.0 };
            chart.series.register(new LiveChart.MinBoundLineSerie.from_serie("MIN OF S2", chart.series.get_by_name("S2"))).line.color = Gdk.RGBA() {red = 0.0, green = 0.0, blue = 1.0, alpha = 1.0 };;
